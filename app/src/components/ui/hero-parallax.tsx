...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 font-semibold font-mono text-neutral-400 ">
        At Goodsly, we bring the world of shopping to your fingertips with
        cutting-edge technology and effortless design. We are passionate about
        delivering quality, value, and convenience, making Goodsly your trusted
        partner for all things shopping.
      </p>
    </div>
  );
};
